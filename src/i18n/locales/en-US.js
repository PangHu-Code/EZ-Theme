...
export default {
    ...
    profile: {
        ...
        removeSessionConfirm: 'Remove this login session? The affected device will need to sign in again.',
        removeSessionSuccess: 'Login session removed',
        removeSessionError: 'Failed to remove login session',
