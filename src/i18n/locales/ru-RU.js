...
export default {
  ...
  profile: {
    ...
    loginSession: 'Сеанс входа',
    removeSession: 'Удалить сеанс',
    removeSessionConfirm: 'Удалить этот сеанс входа? На соответствующем устройстве потребуется войти снова.',
    removeSessionSuccess: 'Сеанс входа удалён',
    removeSessionError: 'Не удалось удалить сеанс входа',
