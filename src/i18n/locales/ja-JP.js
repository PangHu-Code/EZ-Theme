...
export default {
  ...
  profile: {
    ...
    loginSession: 'ログインセッション',
    removeSession: 'セッションを削除',
    removeSessionConfirm: 'このログインセッションを削除しますか？対象の端末では再ログインが必要です。',
    removeSessionSuccess: 'ログインセッションを削除しました',
    removeSessionError: 'ログインセッションを削除できませんでした',
