...
export default {
  ...
  profile: {
    ...
    loginSession: 'نشست ورود',
    removeSession: 'حذف نشست',
    removeSessionConfirm: 'این نشست ورود حذف شود؟ دستگاه مربوطه باید دوباره وارد شود.',
    removeSessionSuccess: 'نشست ورود حذف شد',
    removeSessionError: 'حذف نشست ورود ناموفق بود',
